...
<br>
   ...
   if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
       ...
       <div class="form-group" >
         <label for="exampleInputEmail1">SQUADRON_NO</label>
         <input type="text" class="form-control" id="exampleInputEmail1" name="SQUADRON_NO" aria-describedby="emailHelp" placeholder="Enter Squadron_no">
       </div>
       <br>
       <div class="form-group">
...
<?php
      ...
      $STATUS=$_POST["STATUS"];
      $sql2="INSERT INTO airforce_officers VALUES
      ('$SQUADRON_NO', '$ID_NO', '$NAME','$DOB', '$GENDER', '$RANK', '$REWARDS', '$STATUS');";
    // print_r($sql2);
    $res1=mysqli_query($db, $sql2);
      ...
      if(isset($_POST['delete'])){
        echo "posted";
        $ID_NO=$_POST["ID_NO"];
      $sql="DELETE FROM airforce_officers WHERE ID_NO='$ID_NO';";
...
$all="SELECT * FROM airforce_officers";
