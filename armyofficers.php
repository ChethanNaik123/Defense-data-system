...
<br>
   ...
   if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
       ...
       <div class="form-group" >
         <label for="exampleInputEmail1">SQUAD_NO</label>
         <input type="text" class="form-control" id="exampleInputEmail1" name="SQUAD_NO" aria-describedby="emailHelp" placeholder="Enter Squad_no">
       </div>
       <br>
       <div class="form-group">
...
<?php
      ...
      $STATUS=$_POST["STATUS"];
      $sql2="INSERT INTO army_officers VALUES
      ('$SQUAD_NO', '$ID_NO', '$NAME','$DOB', '$GENDER', '$RANK', '$REWARDS', '$STATUS');";
    // print_r($sql2);
    $res1=mysqli_query($db, $sql2);
      ...
      if(isset($_POST['delete'])){
        echo "posted";
        $ID_NO=$_POST["ID_NO"];
      $sql="DELETE FROM army_officers WHERE ID_NO='$ID_NO';";
