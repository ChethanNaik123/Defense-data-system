...
<br>
   ...
   if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
       ...
       <div class="form-group" >
         ...
         <input type="text" class="form-control" id="exampleInputEmail1" name="UNIT_NO" aria-describedby="emailHelp" placeholder="Enter Squad number">
       </div>
       <br>
       <div class="form-group">
       ...
       <form action="" method="post" class="container">
          <div class="form-group" >
          <label for="exampleInputEmail1">Unit No</label>
          <input type="text" class="form-control" id="exampleInputEmail1" name="UNIT_NO" aria-describedby="emailHelp" placeholder="Enter Unit number">
   </div>   
   <br>  
...
<?php
      ...
      $sql2="INSERT INTO navy (UNIT_NO, BASE, TRAINING, ACCIDENTS) VALUES
      ('$UNIT_NO', '$BASE', '$TRAINING','$ACCIDENTS');";
    // print_r($sql2);
    $res1=mysqli_query($db, $sql2);
      ...
      if(isset($_POST['delete'])){
        echo "posted";
        $UNIT_NO=$_POST["UNIT_NO"];
      $sql="DELETE FROM navy WHERE UNIT_NO='$UNIT_NO';";
